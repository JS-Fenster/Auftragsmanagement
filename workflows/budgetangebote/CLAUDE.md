...
| 8 | Verboten | 270-285 |
| 9 | Projekt-Kontext: Budgetangebot V1 | 287-314 |
| PL | Subagenten-Orchestrierung (NUR PL) | 316+ |
...
### ../05_BACKLOG.md (Feature-Backlog) — ZENTRAL
...
- **WICHTIG:** Es gibt KEINE lokale BACKLOG.md mehr. Alle Items (Budget, Repair, General, Architektur) werden zentral in `workflows/05_BACKLOG.md` gepflegt. Budget-Items nutzen Prefix `B-XXX`.
...
*Version: 2.4 | Erstellt: 2026-02-03 | Aktualisiert: 2026-02-23*
