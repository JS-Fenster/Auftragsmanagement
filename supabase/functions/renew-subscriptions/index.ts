...
// - API-Key Protection (optional: RENEW_SUBSCRIPTIONS_API_KEY or INTERNAL_API_KEY)
...
// =============================================================================
// v1.1: Token Hardening (portiert von email-webhook v3.5)
// =============================================================================
...
async function getAccessToken(): Promise<string> {
  ...
  // v1.1 Hardening: trim whitespace from secret
  ...
  if (!response.ok) {
    ...
    // v1.1: Safe logging - never log the secret
    ...
    return new Response(
      JSON.stringify({
        ...
        configured: {
          ...
          apiKeyProtection: !!(RENEW_SUBSCRIPTIONS_API_KEY || INTERNAL_API_KEY),
        },
        subscriptionLifetimeMinutes: SUBSCRIPTION_LIFETIME_MINUTES,
      }),
      {
        status: 200,
