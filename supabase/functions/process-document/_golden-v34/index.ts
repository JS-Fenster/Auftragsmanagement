...
// - FIX: undefined-Werte wurden von JSON.stringify gestripped → PATCH liess alte Werte stehen
// - Fallback: Fehlende kategorie → "Sonstiges_Dokument", fehlende qualitaet → "niedrig"
//
// Aenderungen v33:
...
async function categorizeAndExtract(ocrText: string, fileName: string): Promise<ExtractedDocument> {
  ...
  // v34: Validate required fields (json_object format does NOT enforce schema)
  if (!parsed.kategorie) {
